# Welcome to the Osint-direction project!

### 🌐 Мой проект предоставит вам знания ,как найти информацию с известных вам данных. В ходе вы узнаете инструменты для поиска, методы поиска, а также полезные фишки в осинте.
...
### Инструменты поиска: Я предложу вам лучшие поисковые системы и платформы, которые помогут вам находить информацию по различным темам. Покажу рабочие методы добычи информации ручным способом⚙
> **Отказ от ответственности Я предоставляю инструменты и знания для поиска информации. Я не несу ответственности за любые убытки или ущерб, которые могут возникнуть в результате использования информации, найденной через полученые знания. Пожалуйста, используйте данный гид ответственно. Всё содержимое моего проекта предоставляется "как есть", без каких-либо гарантий. Пользуясь этим проектом, вы соглашаетесь с вышеуказанными условиями.**

| Search                                    | Addition                                  |  
|-------------------------------------------|-------------------------------------------|
| Nickname                                  | Google Dorks                              |
| Phone Number                              | Social network                            |
| Domain                                    | Crypto Osint                              |
| Ip                                        | Yandex                                    |
| Geoint                                    | Google                                    | 
| GPT OSINT                                 | Vk                                        |
| Telegram                                  | Statistical analysis                      |
| Email                                     | Discord                                   |
| Поиск по СНГ                              | MailRu                                    |
| Поиск за пределами                        | Files                                     |
...
- [BooksOsint](https://t.me/books_osint)

- [Non-typical-Osint-guide](https://github.com/OffcierCia/non-typical-OSINT-guide#training--practicing)

- [OverpassTurboTutorial](https://telegra.ph/Overpass-turbo-dlya-chajnikov-03-26)

- [Real Osint Case](https://www.youtube.com/watch?v=Lij0cpFl9Bw)

- [Как создаются OSINT-расследования. Интервью c профессиональным кибердетективом | Schwarz_Osint](https://rutube.ru/video/6a728831bb72466174c520ae6b2efc78/)
...
[PoiskCenter](https://poisk.center/peoples/chehiya)

[Krak](https://www.krak.dk/)
